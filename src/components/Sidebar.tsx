...
export function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const PAGES: NavItem[] = [
    ...
    { href: '/colaboradores', nome: 'Colaboradores', icon: 'user', grp: 'Análise' },
    { href: '/chatbot/faqs', nome: 'FAQs do chatbot', icon: 'mail', grp: 'Chatbot' },
    { href: '/chatbot/conversas', nome: 'Conversas', icon: 'chart', grp: 'Chatbot' },
    { href: '/conteudos/newsletter', nome: 'Newsletter', icon: 'mail', grp: 'Conteúdos' },
    { href: '/conteudos/impacto', nome: 'Números de impacto', icon: 'tag', grp: 'Conteúdos' },
